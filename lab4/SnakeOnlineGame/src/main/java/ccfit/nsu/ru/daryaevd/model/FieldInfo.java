...
import ccfit.nsu.ru.daryaevd.model.threads.master.MasterActionThread;
...
//                        System.out.println("---- p: " + p);
    ...
    private void fillSquareAround(Point point) { //putting new snakes
...
//                    System.out.println("simple points: " + point);
//                }
//                System.out.println("------- ENDED -------");
